      ...
      <AnimatePresence>
        {showVersionLog && (
          ...
          <motion.div
            ...
            className="flex h-full max-h-full w-full max-w-xl flex-col overflow-hidden rounded-t-2xl border border-primary/20 bg-surface shadow-2xl sm:h-auto sm:max-h-[85vh] sm:rounded-2xl"
          >
